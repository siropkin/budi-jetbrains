...
Privacy Policy points at the dedicated privacy page on the marketing site, where the data lifecycle is documented — the plugin itself only renders what the local daemon returns and transmits nothing.
